...
\item \textbf{However, the DSA is not statistically better at finding tags in the clustered environment.}
\item \textbf{The efficiency of the CPFA is less variable than the DSA.}\\
\end{itemize}
%------------------------------------------------
\begin{center}
\vspace{-1em}\includegraphics[width=0.5\linewidth]{MultiRobot.png}\vspace{-1em}
...
\headerbox{Source Code}{name=sourcecode,column=0,below=references, above=bottom}{
 ...
 \noindent 
  ...
  \url{https://github.com/BCLab-UNM} \\
  
% * <linh17.tran@gmail.com> 2015-09-19T21:36:47.663Z:
%
% 
%
  \vspace{-2mm}
  \noindent
  Project information, including iAnt build instructions and related work, is available at: \\
